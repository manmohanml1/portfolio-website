...
- Anonymous device-local customization that remembers project focus and prioritizes matching evidence, with one restore-defaults action and no account requirement.
