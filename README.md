...
- Anonymous device-local customization with audience-specific evidence ordering, Cards/List project layouts, shareable `?view=` links, and no account requirement.
