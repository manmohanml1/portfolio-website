...
- Anonymous device-local customization with complete audience-specific portfolio variants, spacious Cards/List project layouts, shareable `?view=` links, and no account requirement.
