...
export const experiences = [
  {
    ...
    org: "Amtrak",
    detail:
      "Current public LinkedIn headline associates the profile with Amtrak in the Washington DC-Baltimore Area.",
  },
  {
    role: "Cloud engineering exposure",
    org: "Evernorth Health Services",
    detail:
      "Public LinkedIn preview references AWS Lambda-based work; phrased conservatively because full details require LinkedIn access.",
  },
  {
    role: "Project builder",
    org: "GitHub portfolio",
    detail:
      "Public repositories cover React applications, REST/API practice, LangChain experimentation, data streaming, design patterns, and multi-language testing.",
  },
];
...
export const credentials = [
  ...
  },
  {
    ...
    value: "662 followers · 500+ connections",
  },
  {
  ...
  },
  {
    ...
    value: "Frontend · Backend · Data · AI",
  },
];
