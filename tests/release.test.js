...
test("current release identifies the v1.7 observability candidate", () => {
...
test("roadmap records the v1.7 observability candidate", () => {
  assert.match(roadmap, /\| Control Center Observability .*\| In development for v1\.7\.0 \|/);
});
